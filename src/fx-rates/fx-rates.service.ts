...
export class FxRatesService {
    ...
    async fetchFxRates(from_curr: string, to_curr: string) {
        ...
        const data = await this.getRatesFromApi(from_curr, to_curr);
        console.log(data);
        return {
    ...
    async getRatesFromApi(from_curr: string, to_curr: string) {
        ...
        throw new Error('error in fetching fx rates');
    }
